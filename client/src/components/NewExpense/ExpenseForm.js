...
const ExpenseForm = (props) => {
  ...
  const submitHandler = async (event) => {
    ...
    try {
      ...
      const response = await axios.post("http://localhost:8000/api/v1/products", formData, { headers });
  ...
  return (
    <form onSubmit={submitHandler}>
      <div className="new-expense__controls">
        ...
        <div className="new-expense__control">
          <label>Stock</label>
          <input type="number" min="1" step="1" value={enteredStock} onChange={stockChangeHandler} />
        </div>
        <div className="new-expense__control">
          <label>Date</label>
        ...
        <div className="new-expense__control">
          ...
          <textarea rows="3" value={enteredDescription} onChange={descriptionChangeHandler}></textarea>
        </div>
        <div className="new-expense__control">
          <label>Image</label>
