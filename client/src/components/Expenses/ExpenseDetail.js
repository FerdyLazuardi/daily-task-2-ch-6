      ...
      <div className="card-detail my-md-5 px-md-4 shadow">
        ...
        <div className="product-detail row d-flex px-md-4 mt-md-4">
          ...
          <div className="col-md-7">
            ...
            <p className="desc-product mx-4 mx-md-0">{data?.product?.description}</p>
          ...
          <Link to="/dashboard" className="btn-go-dashboard mb-4 mt-md-4 btn ms-md-4 col-6 col-sm-5 col-md-4 col-xl-2">
            &#8810; Go to Dashboard
          </Link>
        </div>
      </div>
